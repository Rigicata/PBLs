...
namespace PBLCopos.Controllers
{
    public class EstoquesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EstoqueId,SacosdeCopo,Qtd_ML")] Estoque estoque)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EstoqueId,SacosdeCopo,Qtd_ML")] Estoque estoque)
        {
            if (ModelState.IsValid)
            {
